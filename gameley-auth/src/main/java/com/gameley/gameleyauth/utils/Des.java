...
public class Des {
    ...
    public static String strEnc(String data, String firstKey, String secondKey,
        ...
        if (!StringUtil.checkNull(firstKey)) {
            firstKeyBt = getKeyBytes(firstKey);
            firstLength = firstKeyBt.size();
        }
        if (!StringUtil.checkNull(secondKey)) {
            secondKeyBt = getKeyBytes(secondKey);
            secondLength = secondKeyBt.size();
        }
        if (!StringUtil.checkNull(thirdKey)) {
        ...
        if (leng > 0) {
            if (leng < 4) {
                int[] bt = strToBt(data);
                int[] encByte = null;
                if (!StringUtil.checkNull(firstKey) && secondKey != null
                ...
                for (i = 0; i < iterator; i++) {
                    ...
                    int[] encByte = null;
                    if (!StringUtil.checkNull(firstKey) && !StringUtil.checkNull(secondKey)
                            && !StringUtil.checkNull(thirdKey)) {
                        int[] tempBt;
                        int x, y, z;
                        tempBt = tempByte;
                        for (x = 0; x < firstLength; x++) {
                        ...
                        if (!StringUtil.checkNull(firstKey)
                                &&!StringUtil.checkNull(secondKey)) {
                            int[] tempBt;
                            int x, y;
                            tempBt = tempByte;
                            for (x = 0; x < firstLength; x++) {
    ...
    public static String strDec(String data, String firstKey, String secondKey,
        ...
        for (i = 0; i < iterator; i++) {
            ...
            int[] decByte = null;
            if (!StringUtil.checkNull(firstKey) && !StringUtil.checkNull(secondKey) && !StringUtil.checkNull(thirdKey)) {
                int[] tempBt;
                int x, y, z;
                tempBt = intByte;
...
//        Des desObj = new Des();
        System.out.println(Des.strDec("CF759620FA1B3295","www", "gameley", "com"));
